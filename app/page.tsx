...
export default function Home() {
  ...
  return (
    <div className="container ml-0 mt-32 align-left">
      ...
      <Link
        href="/createpost"
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center bg-gray-100 text-white p-4 rounded-full cursor-pointer shadow-lg transition-colors"
      >
        {/* <Send size={18} className="text-gray-100" hover:bg-gray-300 /> */}
      </Link>
    </div>
  );
}
